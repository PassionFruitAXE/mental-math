      ...
      <Main className="flex justify-around items-center">
        <div className="w-5/6 bg-white p-24 relative sm:py-32 rounded-3xl glass-xl shadow-sm lg:w-2/3">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-4 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-4 sm:pt-16 lg:mx-0 lg:max-w-none md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5"></div>
          </div>
